...
<form action="../controlador/empresaModificarBD.php" method="post" name="form1" >
...
<tr>
		...
		<td>
			<?php echo '<input name="rif" type="text" id="rif" size="15" value="'.$_SESSION['rif'].'" disabled="disabled" />'; ?>
		</td>
	...
	<tr>
		...
		<td>
			 <?php echo '<input name="nombre" type="text" id="nombre" size="20" value="'.$_SESSION['nombre'].'" onkeyup="this.value=this.value.toUpperCase()" /> ';?>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			<?php echo '<input name="direccion" type="text" id="direccion" size="20" value="'.$_SESSION['direccion'].'" onkeyup="this.value=this.value.toUpperCase()" /> ';?>
		</td>
	</tr>
