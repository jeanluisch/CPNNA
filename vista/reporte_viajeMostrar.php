...
<div id="contenedor">
	...
	<br><br>
	<center> <h2> Reporte de Viaje </h2> </center>  
	
	<?php
      
	 $ced= $_SESSION['ci_adorv'];
	 ...
	 echo "
		...
		<table cellpadding='5' border='0' width='550px' bgcolor='#3E3E3E'>
          <tr>
		      <th bgcolor='red'><font size='4' color='white' face='arial'><span class='icon-profile' ><font size='4'></font></span>Núm. Solicitud</font></th>
	 ...
	 while($registro=mysql_fetch_array($result)){
		echo "<tr> <center>
			...
			<td bgcolor='#F0F0F0' align='center'><a href='../controlador/recibirreporte.php?id= $registro[id_viaje] ' target='_blank'><img src='../image/viajereporte.png' title='Generar Reporte' height='35'></a><font size='4' color='black' face='arial'></font></td>
			</center>
			</tr>";
	   	    }
?>
