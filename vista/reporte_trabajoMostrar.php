...
<html>
<head><title>Reporte de Trabajo</title>
<meta charset="UTF-8"/>
...
<div id="contenedor">
	...
	<center> <h2> Reporte Solicitúd de Trabajo</h2> </center>  
  ...
  $obj->conectar();
	 ...
	 while($registro=mysql_fetch_array($result)){
		echo "<tr> <center>
			...
			<td bgcolor='#F0F0F0' align='center'><a href='../controlador/reporte_trabajoMostrarBD.php?id= $registro[id_trabajo] '><img src='../image/modificar.gif' title='Ir a Reporte' height='20'></a><font size='4' color='black' face='arial'></font></td>
