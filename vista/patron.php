...
<form action="../controlador/patronbuscarBD.php" method="post" name="form1" onsubmit="return validarForm();" >

<center> <h2> Patr&oacuten <h2> </center> 
	...
	<tr>
		...
		<td>
			...
			<input type= "text" name= "cedula" id="cii" maxlength ="8" size="15" >
		</td>
...
<br>
	...
	<table align ="center">
		<tr>
         		<td><input type="submit" name="btnBuscar" id="btnBuscar" value="Buscar"/>
			</td>
	</table>
