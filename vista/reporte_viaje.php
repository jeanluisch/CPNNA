...
<form action="../controlador/reporte_viajeBuscar.php" method="post" name="form1" onsubmit="return validarForm();">

	<br><br>
<tr> 	<center> <h2> Reporte Autorización de Viaje </center> <h2> </tr>
	...
	<table border ="0" align ="center" >
		...
		<td>
			...
			<input type= "text" name= "ci_ado" id="cii" maxlength ="8" >
		</td>
