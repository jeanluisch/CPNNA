...
<form action="../controlador/acompanianteModificarBD.php" method="post" name="form1" >
...
<tr> 	<center> <h2> Acompa&ntildeante </center> <h2> </tr>
	...
	<tr>
		...
		<td>
			 <?php echo '<input name="nombre" type="text" id="nombre" value="'.$_SESSION['nombre'].'" /> ';?>
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<?php echo '<input name="apellido" type="text" id="apellido"  value="'.$_SESSION['apellido'].'" /> ';?>
		</td>
	</tr>
