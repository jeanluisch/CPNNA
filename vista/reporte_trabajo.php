...
<form action="../controlador/reporte_trabajoBuscar.php" method="post" name="form1" onsubmit="return validarForm();" >

	</table>
<tr> 	<center> <h2> Reporte Solicitúd de Trabajo </center> <h2> </tr>
	...
	<table border ="0" align ="center" >
		...
		<td>
			...
			<input type= "text" name= "ci_adot" id="cii" maxlength ="8" >
		</td>
