...
<html>
<head><title>Solicitud de Trabajo</title>
<meta charset="UTF-8"/>
...
<div id="contenedor">
	...
	<center> <h2> Solicitúd de Trabajo </h2> </center>  
	
	<?php
  include("../modelo/BD.php");
  include("../modelo/clasesolicitud_trabajo.php");
  $solicitud_trabajo=new solicitud_trabajo();
  $obj=new conexion();
  $obj->conectar();
 
      
	 $ced= $_SESSION['ci_ado'];
	 $solicitud_trabajo->ci_ado=$ced;
  
	 $result=$solicitud_trabajo->consultar();
         $num=0;	 
	 
	 $num=$solicitud_trabajo->contar();
	 echo "<br>
        <center><font size='5'>
		<table cellpadding='5' border='0' width='500px' bgcolor='#3E3E3E'>
          <tr>
		      <th bgcolor='red'><font size='4' color='white' face='arial'><span class='icon-profile' ><font size='4'></font></span>Número Solicitud</font></th>
			  <th bgcolor='#0081CC'><font size='4' color='white' face='arial'><span class='icon-file' ><font size='4'></font></span>Cédula</font></th>
			  <th bgcolor='#0081CC'><font size='4' color='white' face='arial'><span class='icon-file' ><font size='4'></font></span>Acción</font></th>
		  </tr>";
	 while($registro=mysql_fetch_array($result)){
		echo "<tr> <center>
			<td bgcolor='#F0F0F0' align='center'><font size='4' color='black' face='arial'>$registro[id_trabajo]</font></td>
			<td bgcolor='#F0F0F0' align='center'><font size='4' color='black' face='arial'>$registro[ci_ado]</font></td>
			<td bgcolor='#F0F0F0' align='center'><a href='../controlador/solicitud_trabajoMostrarBD.php?id= $registro[id_trabajo]; '><img src='../image/modificar.gif' title='Modificar' height='20'></a><font size='4' color='black' face='arial'></font></td>
...
?>
<form action="../controlador/solicitud_TrabajoNuevaBD.php" method="post" name="form1" >
