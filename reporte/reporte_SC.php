			...
			<tr> 
				<td align="center" >
					<p align="justify">
						...
						Previa autorización de su representante (madre), <b> '. $_SESSION['nombre_rmsnc']. ' '. $_SESSION['apellido_rmsnc']. '</b>
						 Titular de la cédula de identidad. <b> '. $_SESSION['ci_rmsnc']. '</b>, Residente: <b> ' .$_SESSION['direccion_rmsnc']. '</b>,
						 
						 y Previa autorización de su representante (padre), <b> '. $_SESSION['nombre_rpsnc']. ' '. $_SESSION['apellido_rpsnc']. '</b>
						 Titular de la cédula de identidad. <b> '. $_SESSION['ci_rpsnc']. '</b>, Residente: <b> ' .$_SESSION['direccion_rpsnc']. '</b>,
						  AUTORIZO al niño, niña y/o adolescente plenamente identificado como <b> '. $_SESSION['nombre_asnc']. ' '. $_SESSION['apellido_asnc']. '</b> 
...
$dompdf->render();
$dompdf->stream("ReporteViaje.pdf");
?>
